...
int main()
{
	...
	// - Alertable Wait -> Completion Port 결과 처리를 GetQueuedCompletionStatus
	// 쓰레드랑 궁합이 굉장히 좋다!
	...
	while (true)
	{
		...
		// 소켓을 CP에 등록
		// key값은 아무거나 넣어주면 됨. 우린 그냥 session값을 넣어줌
		...
		// 유저가 게임 접속 종료! -> 이러면 session은 유효하지 않아서 크래시 발생
		// recv()를 걸어준 session은 날리지 못하도록 막아줘야 한다!
